...
include 'includes/wallet.php';
	...
	if($_SESSION['customer_sid']==session_id())
	 if (isset($_POST['create_food'])){
      ...
      $food_name = $_POST['item'];

      $food_Price = $_POST['Price'];
	  
	  $food_quantity = $_POST['quantity'];

     $insert_food = "INSERT INTO food(item, Price, quantity) VALUES ('$food_name', '$food_Price', '$food_quantity')";

      mysqli_query($con, $insert_food) or die (mysqli_error($con));
      ...
      <!-- END LEFT SIDEBAR NAV-->
		...
		<div class="container"  data-ng-app ="signUpForm" data-ng-controller ="myCtrl">
				<div class="row">
					...
					<button class="btn cyan waves-effect waves-light right" type="submit" name="create_food">Submit<i class="mdi-content-send right"></i>
					</button>
		</div>
					</form>
				</div>		
