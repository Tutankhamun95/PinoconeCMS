			...
			<tbody>
				<?php
					...
					while($row=$query->fetch_array()){
						?>
						<tr>
							<td><a href="<?php if(empty($row['photo'])){echo "order/upload/noimage.jpg";} else{echo $row['photo'];} ?>"><img src="<?php if(empty($row['photo'])){echo "order/upload/noimage.jpg";} else{echo $row['photo'];} ?>" height="30px" width="40px"></a></td>
							...
							<td>
								...
								<?php include('order/product_modal.php'); ?>
							</td>
						</tr>
						<?php
					}
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#catList").on('change', function(){
			...
			{
				window.location = 'order/product.php?category='+$(this).val();
			}
		});
	});
</script>
