<!-- 
  Created by: Aylwin
  Last Updated: 03 May 2018 10:25PM (Sprint 2 Day 4)
  Last Description: Admin can view feedbacks in the DB
-->
  ...
  <div id="main">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Feedbacks from Customers</p>
          ...
          <table>
            <tr>
              ...
              while ($row_feedback = mysqli_fetch_array($run_feedbacks))
              {
                $feedback_id = $row_feedback['id'];

                $feedback_name = $row_feedback['name'];

                $feedback_subject = $row_feedback['subject'];

                $feedback_type = $row_feedback['type'];

                if ($feedback_type == 1){
                    $feedback_type = "Food Quality";
                  } else {
                    $feedback_type = "Service Quality";
                  }

                $feedback_comment = $row_feedback['comment'];

                echo "
                <tr>
                  <td>$feedback_id</td>
                  <td>$feedback_name</td>
                  <td>$feedback_subject</td>
                  <td>$feedback_type</td>
