...
<table>
				...
				while($row = mysqli_fetch_array($result))
				{
                   ...
                   echo '<td><input href="routers/delete-users.php" type="submit" name="delete" value="'.$row['id'].'" /></td>"';
				}
				?>
                    </tbody>
</table>
...
<table>
            ...
            <form class="formValidate" id="formValidate" method="post" action="routers/delete-users.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Delete User</h4>
              </div>
              <div>
<table>
                    <thead>
			  ...
			  <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="action">Remove
                                <i class="mdi-content-send right"></i>
                              </button>
                            </div>
            </div>
